...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # This function creates the decoder for the loaded convolutional VGG model to create the FCN-8s model
    # See "Fully Convolutional Networks for Semantic Segmentation", Long, Shelmaher, Darrel at UC Berkeley
    # Also see Lesson 10 (Scene Understanding) Section 7 FCN-8 Encoder and Section 8 FCN-9 Decoder
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    # See Lesson 10 Scene Understanding Section 9 FCN-8 Classification and Loss

    
    # Reshape from 4d tensor (batch, height, width, channel) to 2d tensor (num_classes, pixels)
    # Note: It turns out that there is no need to reshape final layer tensor since TF softmax function 
    # accepts tensors of any shape and applies softmax function on last a
    xis of the tensor
    ...
    #l2_const = 0.001        # in range [0.002, 0.005]
...
def run():
    ...
    with tf.Session() as sess:
        ...
        model_path = "./save-model-fcn/model3"
